...
public abstract class AbstractClockCanvas extends JPanel {
    ...
    private final ClockObserver _observer;
    ...
    AbstractClockCanvas(ClockObservable observable){
        this.size=SIZE;
        this.p_h=0;
        this.p_m=0;
        this.p_s=0;

        _observer =new ClockObserver(observable,this);
